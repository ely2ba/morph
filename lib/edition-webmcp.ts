import type { BackgroundMode, MinimumId, TopicId } from "./edition";
  ...
  return [
    {
      ...
      description:
        "Read this page before creating or changing an edition. Returns the fixed fictional newsroom dataset, supported controls, current revision, edition selection, verified fact IDs, provenance, locks, pins, hidden sources, comparison state, and exact relaxations.",
      inputSchema: {
        type: "object",
        properties: {},
        additionalProperties: false,
    ...
    },
    {
      ...
      description:
        "Apply safe semantic changes to the current finite edition. Call read_page first and pass its revision. Human topic locks, control locks, pinned developments, and hidden publications are preserved.",
      inputSchema: {
        type: "object",
        properties: {
          base_revision: { type: "integer", minimum: 0 },
